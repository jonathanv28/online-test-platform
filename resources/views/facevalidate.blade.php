...
@section('content')
    ...
    <form action="/validate" method="post" class="text-center mx-auto w-2/5" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <button type="submit"
            class="w-full text-white bg-grass hover:bg-grassbold focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Ambil & Validasi Foto</button>
        </div>
    </form>
    @endif
