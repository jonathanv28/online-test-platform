<nav class="bg-white border-gray-300 dark:bg-gray-900 shadow-lg border-b-2">
        ...
        <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse mr-4">
            ...
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
                ...
                <ul class="py-2" aria-labelledby="user-menu-button">
                    <li>
                        <a href="/"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-green-100">Dashboard</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-green-100">Tambah Tes</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-green-100">Data Diri</a>
                    </li>
                    <li>
                        <form action="/logout" method="POST" class="block px-4 py-2 text-sm text-gray-700 hover:bg-red-200">
                            @csrf
    ...
    <div id="drawer-navigation"
        ...
        <h5 id="drawer-navigation-label" class="text-base font-semibold text-gray-500 dark:text-gray-400">Online Test Platform
        </h5>
