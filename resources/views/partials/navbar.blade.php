<nav class="bg-white border-gray-300 dark:bg-gray-900 shadow-lg border-b-2">
    <div class="flex items-center justify-between mx-auto p-4 h-14">
        <a class="flex items-center space-x-3 rtl:space-x-reverse">
            <div class="text-center">
                <button
                    class="inline-flex items-center p-2 w-8 h-8 justify-center text-sm text-darkblue rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
            ...
            <span class="text-lg font-bold whitespace-nowrap text-darkblue">Online Test Plaftorm</span>
        </a>
        <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse mr-4">
            <button type="button"
                ...
                <img class="w-8 h-8 rounded-full object-cover" src="{{ asset('storage/' . auth()->user()->photo) }}"
                    alt="user photo">
            </button>
            <!-- Dropdown menu -->
    ...
    <!-- overlay -->
    <div id="drawer-overlay" class="fixed inset-0 bg-black opacity-50 z-30 hidden"></div>

    <!-- drawer component -->
    <div id="drawer-navigation"
        class="fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800"
        tabindex="-1" aria-labelledby="drawer-navigation-label">
        <h5 id="drawer-navigation-label" class="text-base font-semibold text-gray-500 dark:text-gray-400">Online Test
            Platform
        </h5>
        ...
        <div class="py-4 overflow-y-auto">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <button href="#"
                        class="flex w-full text-left items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-green-100 dark:hover:bg-gray-700 group"
                        data-modal-target="addtest-modal-nav1" data-modal-toggle="addtest-modal-nav1">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Add Test</span>
                        </a>
                </li>
                <!-- Main modal -->
                <div id="addtest-modal-nav1" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div
                                ...
                                <button type="button"
                                    ...
                                    data-modal-hide="addtest-modal-nav1">
                            ...
                            <!-- Modal body -->
                            <div class="px-4">
                                <form class="space-y-4" action="/tests" method="POST">
                                    @csrf
                                    <div>
                                        <label for="code-nav1"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Test
                                            code</label>
                                        <input type="text" name="code" id="code-nav1"
                                            ...
                                            placeholder="Input Test Code" required autofocus/>
                                    </div>
                                    <div class="flex justify-between">
                                        <button type="submit"
                                            class="mb-6 w-full text-white bg-grass hover:bg-grassbold focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <li>
                    <a href="/profile"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">My Information</span>
                    </a>
                </li>
