...
<body class="font-inter">
    <div class="container mx-auto lg:px-20 xl:px-32 md:px-7 sm:px-7 max-[359px]:px-3 mt-12">
        <div class="w-full max-w-5xl p-4 bg-white rounded-lg sm:p-6 md:p-8">
            ...
            <form class="space-y-3.5 space-x-3.5" action="/login" method="POST">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="phone" class="block mb-2 text-sm font-normal text-gray-900">Nomor Kontak (Opsional)</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <div>
                        <label for="idcard" class="block mb-2 text-sm font-normal text-gray-900">Kartu
                            Identitas</label>
                        <div class="relative">
                            <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" id="idcard" name="idcard" type="file" required>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" id="photo" name="photo" type="file" required>
