                        ...
                        <div>
                            ...
                            <div class="relative mb-4">
                                ...
                                <input type="text" name="title" id="title"
                                    ...
                                    placeholder="Input Test Title" required value="{{ old('title') }}">
                            </div>
                            <div class="grid grid-cols-2 gap-6">
                                ...
                                <div class="flex-col flex">
                                    <label for="imagepreview" class="block mb-2 text-sm font-normal text-gray-900">Image Preview</label>
                                    <img src="" class="border bg-gray-50 rounded-lg flex-grow object-cover" id="imagepreview" alt="">
                                </div>
                                <div class="">
                                    <label for="dropzone" class="block mb-2 text-sm font-normal text-gray-900">Image Upload</label>
                                    <label for="dropzonefile" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600" id="dropzone">
