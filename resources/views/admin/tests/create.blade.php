                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                ...
                                <div class="flex-col flex">
                                    <label for="imagepreview" class="block mb-2 text-sm font-normal text-gray-900">Image
                                        Preview</label>
                                    <img src="" class="border bg-gray-50 rounded-lg flex-grow object-cover"
                                        id="imagepreview" alt="">
                                </div>
                                <div class="">
                            ...
                            <div class="mt-4">
                                <button type="submit" id="submit-create-form"
                                    class="transition duration-200 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create
                                    Test
                                </button>
                            </div>
                    </form>
