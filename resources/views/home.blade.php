                ...
                @foreach ($enrolledTests as $enrolled)
                    <div
                        ...
                        <div class="p-5">
                            ...
                            @else
                                <button
                                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-grass rounded-lg hover:bg-grassbold focus:ring-4 focus:outline-none focus:ring-green-200" onclick="window.location.href='{{ route('tests.validate', $enrolled->tests->id) }}'">
                                    Start
