...
<div class="py-16 px-32">
    ...
    <div class="absolute top-4 mt-8 right-4 z-50">
        <div id="toast-success" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
            ...
            <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" aria-label="Close" data-dismiss-target="#toast-success">
    ...
    @if(session()->has('info'))
    <div class="absolute top-4 mt-8 right-4 z-50">
        <div id="toast-success" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert" data-aos="fade-left"
            ...
            <div class="px-4">
                <form id="addtest-form" class="space-y-4" action="/tests" method="POST">
                    ...
                    <div class="flex justify-between">
                        <button type="submit" class="mb-6 w-full text-white bg-blue-700 hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-4">
                        <form id="addtest-form" class="space-y-4" action="/tests" method="POST">
                            ...
                            <div>
                                <label for="code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Test code</label>
                                <input type="text" name="code" id="code" autofocus class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Input Test Code" required />
                            </div>
                            <div class="flex justify-between">
                                <button type="submit" class="mb-6 w-full text-white bg-blue-700 hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add</button>
                            </div>
                        </form>
                    </div>
    </div>
                ...
                @foreach ($enrolledTests as $enrolled)
                    <div
                        ...
                        <div class="p-5">
                            ...
                            @else
                                <button
                                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-blue-200" onclick="window.location.href='{{ route('tests.validate', $enrolled->tests->id) }}'">
                                    Start
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            {{-- <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (toast) {
                        setTimeout(() => toast.classList.add('hidden'), 3000); // Auto-hide after 3 seconds
                    }
                });
            </script> --}}
@endsection
